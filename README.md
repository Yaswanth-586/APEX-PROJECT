...
Home Page - Stream selection (Intermediate, B.Tech, Degree)
Year Page - Semester grid (SEM1-SEM8)
Subjects Page - Subject cards with study material links
Settings Page - App preferences and account management
Edit Profile Page - Update user information
Change Password Page - Secure password management
🏗️ Architecture
...
firebase init
Update repositories to use Firebase instead of mock data

Configure authentication with Firebase Auth
